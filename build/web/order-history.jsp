                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            <h2 style="color: black">Shopping History</h2>
                            <div class="breadcrumb__option">
                                <a href="DispatchController" style="color: black">Home</a>
                                <span style="color: black">Shopping History</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 offset-3">
                        <div class="shoping__cart__table">
                            <table style="width: 0;">
                                ...
                                <tbody>
                                    <c:set var="historys" value="${requestScope.HISTORY}" />
                                    <c:forEach var="history" items="${historys}" >
                                    <form action="DispatchController">
                                        <input type="hidden" name="BillID" value="${history.billID}" />
                                        <tr>
                                            ...
                                            <td class="shoping__cart__total">
                                                ${history.billPaymentM}
                                            </td>
                                            <td class="shoping__cart__item__close">
                                                <button name="btAction" value="ShowBillDetail" style="color: black; border: 0; background: white;"><i class="fa fa-info-circle" aria-hidden="true"></i></button>
                                            </td>
                                        </tr>
                                    </form>
                                </c:forEach>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="shoping__cart__btns">
                            <a href="DispatchController" class="primary-btn cart-btn">GO SHOPPING</a>
                        </div>
                    </div>
                </div>
            </div>
