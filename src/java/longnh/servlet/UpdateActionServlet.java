    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!isMultipart) {
                ...
                String id = (String) params.get("foodID");
                ...
                String category = (String) params.get("foodCategory");
                String quantity = (String) params.get("foodQuantity");

                FoodDAO foodDAO = new FoodDAO();
                boolean updateFood = foodDAO.updateFood(id, name, img, description, 
                        Float.parseFloat(price), date, category, Integer.parseInt(quantity));
            ...
            log("UpdateActionServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
