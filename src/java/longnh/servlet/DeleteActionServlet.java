 ...
 * @author LongNH
 */
@WebServlet(name = "DeleteActionServlet", urlPatterns = {"/DeleteActionServlet"})
public class DeleteActionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean deleteAccount = foodDAO.deleteFood(foodID);
            
            if (!deleteAccount) {
                url = ERRORS_PAGE;
            }
        } catch (SQLException ex) {
            log("DeleteActionServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
