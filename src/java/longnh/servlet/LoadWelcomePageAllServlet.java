 ...
 * @author LongNH
 */
@WebServlet(name = "LoadWelcomePageAllServlet", urlPatterns = {"/LoadWelcomePageAllServlet"})
public class LoadWelcomePageAllServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodDAO.loadListFoods(index);
            
            List<FoodDTO> listFoods = foodDAO.getListFoods();
            int count = foodDAO.countFood();
            int sizePage = 8;
            ...
            log("LoadWelcomePageAllServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
