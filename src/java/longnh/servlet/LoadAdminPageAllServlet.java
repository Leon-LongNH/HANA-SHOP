 ...
 * @author LongNH
 */
@WebServlet(name = "LoadAdminPageAllServlet", urlPatterns = {"/LoadAdminPageAllServlet"})
public class LoadAdminPageAllServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodDAO.loadListFoodsAdmin(index);
            ...
            log("LoadAdminPageAllServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
