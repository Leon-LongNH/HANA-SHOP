 ...
 * @author LongNH
 */
@WebServlet(name = "LoadAdminPageByCategoryServlet", urlPatterns = {"/LoadAdminPageByCategoryServlet"})
public class LoadAdminPageByCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodDAO.loadListFoodsByCategoryAdmin(key, index);
            
            List<FoodDTO> listFoods = foodDAO.getListFoods();
            
            int count = foodDAO.countFoodCategoryAdmin(key);
            int sizePage = 8;
            ...
            request.setAttribute("KEY_CATEGORY", key);
        } catch (SQLException ex) {
            log("LoadAdminPageByCategoryServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
