 ...
 * @author LongNH
 */
@WebServlet(name = "LoadWelcomePageByCategoryServlet", urlPatterns = {"/LoadWelcomePageByCategoryServlet"})
public class LoadWelcomePageByCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodDAO.loadListFoodsByCategory(key, index);
            
            List<FoodDTO> listFoods = foodDAO.getListFoods();
            
            int count = foodDAO.countFoodCategory(key);
            int sizePage = 8;
            ...
            log("LoadWelcomePageByCategoryServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
