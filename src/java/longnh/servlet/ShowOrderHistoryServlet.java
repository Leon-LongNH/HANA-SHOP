...
public class ShowOrderHistoryServlet extends HttpServlet {
    ...
    private final String HISTORY_PAGE = "order-history.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            billDAO.loadListBill(accountDTO.getUsername());
            List<BillDTO> listBills = billDAO.getListBills();
            
            request.setAttribute("HISTORY", listBills);
        } catch (SQLException ex) {
            log("ShowOrderHistoryServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
