 ...
 * @author LongNH
 */
@WebServlet(name = "LoadAdminPageBySearchServlet", urlPatterns = {"/LoadAdminPageBySearchServlet"})
public class LoadAdminPageBySearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodDAO.loadListFoodsBySearchAdmin(keySearch, index);
            List<FoodDTO> listFoods = foodDAO.getListFoods();
            
            request.setAttribute("ALL_FOOD", listFoods);
            
            int count = foodDAO.countFoodAdmin();
            int sizePage = 8;
            ...
            log("LoadAdminPageBySearchServlet _ " + ex.getMessage());
            url = ERRORS_PAGE;
