<%-- 
    ...
    Created on : Jan 19, 2021, 5:28:19 PM
    Author     : LongNH
--%>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            <h2 style="color: black">Check Out</h2>
            ...
            <div class="container">
                ...
                <div class="checkout__form">
                    ...
                    <form action="DispatchController">
                        <div class="row">
                            <div class="col-lg-4 offset-4 col-md-6">
                                <div class="checkout__order">
                                    ...
                                    <ul>
                                        <c:forEach var="cart" items="${carts}" >
                                            <c:set var="subtotal" value="${subtotal + (cart.key.foodPrice * cart.value)}" />
                                            <c:set var="total" value="${total + (cart.key.foodPrice * cart.value)}" />
                                            <li>${cart.key.foodName} <span>$${cart.key.foodPrice * cart.value}</span></li>
                                    ...
                                    <div class="checkout__input__checkbox">
                                        <label for="paypal">
                                            Paypal
                                            <input type="checkbox" id="paypal" name="Paypal" value="ON">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <button type="submit" class="site-btn" name="btAction" value="PlaceOrder">PLACE ORDER</button>
                                </div>
                            </div>
                        </div>
                    </form>
